...
class FirstWordAgent(cap.Agent):
    """
    A simple agent which selects the first playable word from the dictionary.
    """
    ...
    def act(self, state):
        ...
        print("[first_word-%s] Playing word %s" % (state.turn, word_to_play))
